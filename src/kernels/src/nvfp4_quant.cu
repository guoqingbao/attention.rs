...
// Uses precise division __fdiv_rn instead of __fdividef or rcp.approx.ftz:
//   SFValue = __fdiv_rn(SFScaleVal * vecMax, 6.0f)
//   fp8_scale = fp8_e4m3(SFValue)
//   outputScale = __fdiv_rn(SFScaleVal, float(fp8_scale))
