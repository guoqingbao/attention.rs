...
// SM120 tiles matching dispatchNVFP4xNVFP4GemmCTAShapeSm120.
// Macro requires SWAP_AB_; also emits StreamK launchers.
#define INSTANTIATE_SM120_FP4_TILE(TYPE, CTA_M, CTA_N, CTA_K)                           \
...
#define INSTANTIATE_SM120_FP4_ALL(TYPE)           \
  INSTANTIATE_SM120_FP4_TILE(TYPE, 128, 32, 128)  \
  INSTANTIATE_SM120_FP4_TILE(TYPE, 128, 32, 256)  \
  INSTANTIATE_SM120_FP4_TILE(TYPE, 128, 64, 128)  \
  INSTANTIATE_SM120_FP4_TILE(TYPE, 128, 64, 256)  \
  INSTANTIATE_SM120_FP4_TILE(TYPE, 128, 128, 128) \
  INSTANTIATE_SM120_FP4_TILE(TYPE, 128, 128, 256) \
  INSTANTIATE_SM120_FP4_TILE(TYPE, 256, 128, 128) \
  INSTANTIATE_SM120_FP4_TILE(TYPE, 128, 256, 128)

INSTANTIATE_SM120_FP4_ALL(half)
INSTANTIATE_SM120_FP4_ALL(__nv_bfloat16)

#undef INSTANTIATE_SM120_FP4_ALL
#undef INSTANTIATE_SM120_FP4_TILE
